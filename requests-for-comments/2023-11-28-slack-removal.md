...
The same isn't true for users, a small ([but declining](/images/2023-11-28-slack-removal/slack.png)) number of whom still use it almost universally for submitting support requests. Often these don't get a response from us (because it's not a support channel) or other users (because we've failed to foster a true community on Slack).
